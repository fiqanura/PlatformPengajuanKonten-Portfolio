                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        {submission.tanggalSubmit ? formatDateTime(submission.tanggalSubmit) : '-'}
                      </p>
                    </div>
                    <div>
                        ...
                        <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                          ...
                          <div className="text-sm text-red-700 space-y-1">
                            ...
                            <p>
                              ...
                              {item.tanggalTakedown && formatDateTime(item.tanggalTakedown)}
                            </p>
                            <p>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">
                            {item.tanggalOrderMasuk ? formatDate(item.tanggalOrderMasuk) : "-"}
                          </p>
                        </div>
                        <div>
                          <Label className="text-xs font-medium text-gray-600">Tanggal Jadi</Label>
                          <p className="text-gray-900">
                            {item.tanggalJadi ? formatDate(item.tanggalJadi) : "-"}
                          </p>
                        </div>
                        <div>
                          <Label className="text-xs font-medium text-gray-600">Tanggal Tayang</Label>
                          <p className="text-gray-900">
                            {item.tanggalTayang ? formatDate(item.tanggalTayang) : "-"}
                          </p>
                        </div>
                        <div>
