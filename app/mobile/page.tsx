  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r from-blue-300/20 to-purple-300/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-r from-green-300/20 to-teal-300/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="px-4 space-y-4">
        ...
        <div>
          ...
          >
            <CardContent className="p-6 relative">
              ...
              {/* Floating elements */}
              <div className="absolute top-4 right-16 w-2 h-2 bg-white/40 rounded-full" />
              <div className="absolute bottom-6 right-8 w-1 h-1 bg-white/60 rounded-full" />
            </CardContent>
          </Card>
        </div>
        ...
        {!isAuthenticated && (
          <div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.9 }}>
            <Card
