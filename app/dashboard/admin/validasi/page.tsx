        ...
        if (response.success && response.data) {
          ...
          const transformedData = validationItems.map((item: any) => {
            ...
            return {
              ...
              isConfirmed: item.is_confirmed !== false && item.isConfirmed !== false,
              isOutputValidated: item.validated_at ? true : (item.validationStatus === 'published' || item.isOutputValidated === true),
              workflowStage: item.workflow_stage || item.workflowStage || "validation",
              tanggalReview: item.reviewed_at || item.reviewedAt,
